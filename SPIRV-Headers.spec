...
Source0  : https://github.com/KhronosGroup/SPIRV-Headers/archive/1.5.3.tar.gz
...
%prep
%setup -q -n SPIRV-Headers-1.5.3
cd %{_builddir}/SPIRV-Headers-1.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589524155
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/SPIRV-Headers-1.5.3/LICENSE %{buildroot}/usr/share/package-licenses/SPIRV-Headers/9a84200f47e09abfbde1a6b25028460451b23d03
pushd clr-build
%make_install
popd
