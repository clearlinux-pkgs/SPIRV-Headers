...
Version  : 1.4.1
Release  : 3
URL      : https://github.com/KhronosGroup/SPIRV-Headers/archive/1.4.1/SPIRV-Headers-1.4.1.tar.gz
Source0  : https://github.com/KhronosGroup/SPIRV-Headers/archive/1.4.1/SPIRV-Headers-1.4.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557388145
mkdir -p clr-build
pushd clr-build
