...
Version  : 1.3.290.0
Release  : 14
URL      : https://github.com/KhronosGroup/SPIRV-Headers/archive/vulkan-sdk-1.3.290.0/SPIRV-Headers-1.3.290.0.tar.gz
Source0  : https://github.com/KhronosGroup/SPIRV-Headers/archive/vulkan-sdk-1.3.290.0/SPIRV-Headers-1.3.290.0.tar.gz
...
%prep
%setup -q -n SPIRV-Headers-vulkan-sdk-1.3.290.0
cd %{_builddir}/SPIRV-Headers-vulkan-sdk-1.3.290.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727457143
mkdir -p clr-build
pushd clr-build
