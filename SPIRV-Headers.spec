...
Source0  : https://github.com/KhronosGroup/SPIRV-Headers/archive/1.5.1/SPIRV-Headers-1.5.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570467397
mkdir -p clr-build
pushd clr-build
